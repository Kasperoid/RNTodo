...
import {setDescTodo} from '../redux/slices/todosListSlice';

export const TodoDescPage = () => {
      ...
      {isOpenInput ? (
        <View>
          ...
          <View style={{gap: 5, marginTop: 15}}>
            <ButtonUI type={'Primary'} onPressFunc={() => confirmBtnHandler()}>
              Ввести
            </ButtonUI>
            <ButtonUI type={'Secondary'} onPressFunc={() => cancelBtnHandler()}>
              Отменить
            </ButtonUI>
          </View>
        </View>
